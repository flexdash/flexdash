<!-- IFrame - Widget to embed something smallish from another site.
...
<style scoped>
iframe {
  padding: 4px 4px 4px 4px; border: 0px;
...
full page see the i-frame grid.`,
  ...
  props: {
    url: { type: String, default: 'https://user-images.githubusercontent.com/19274367/' +
